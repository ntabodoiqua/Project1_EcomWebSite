...
if(isset($_POST['insert_product'])){
    ...
    $product_image1 == '' || $product_image2 == '' || $product_image3 == '' || $product_link == ''){
        ...
        $insert_products="insert into `products` (product_title, product_description, product_keyword, category_id, brand_id,
                            product_image1, product_image2, product_image3, product_price, date, status, product_link, product_youtube, total_number) 
                            values ('$product_title', '$description', '$product_keywords', '$product_category', '$product_brands', 
                            '$product_image1', '$product_image2', '$product_image3', '$product_price', NOW(), '$product_status', '$product_link', '$product_youtube', '$num_pro_avail')";
        ...
        <table class="table table-bordered table-hover table-striped mt-5">
            ...
            <tbody>
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <!-- youtube -->
                    <tr>
                        <td><label for="product_youtube">Link sản phẩm</label></td>
                        <td><input type="text" name="product_youtube" id="product_youtube" class="form-control" placeholder="Liên kết video youtube" required></td>
                    </tr>
                    <!-- Số lượng -->
                    <tr>
