            ...
            <div class="col-lg-12 col-xl-6">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="text" id="user_fullname" class="form-control"  placeholder="Điền họ và tên" autocomplete="off" required="required" name="user_fullname"/>
                    </div>
                    <div class="form-outline mb-4">
                        <!-- password -->
...
if(isset($_POST['user_register'])){
    ...
    $insert_query="insert into `user_table` (username, user_fullname, user_email, user_password, user_image, user_address, user_phone)
    values ('$user_username', '$user_fullname', '$user_email', '$hash_password', '$user_avatar', '$user_address', '$user_phone')";
